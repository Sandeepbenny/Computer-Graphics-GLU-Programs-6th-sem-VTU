...
void graphics()
{
	...
	setcolor(RED);
	settextstyle(0, 0, 2);
	outtextxy(250, 13, "Scientific Calculator");
	outtextxy(250, 450, "A CG Mini-Project");
	settextstyle(8, 0, 1);
	outtextxy(420, 38, "- By");
	outtextxy(445, 55, "46 -Pranav Yadav");
	outtextxy(445, 70, "31 -Harshit Shetty");
	outtextxy(445, 85, "20 -Rohit Rahatal");
	setcolor(8);
	rectangle(0, 0, 160, 423);	// choice list
	setfillstyle(SOLID_FILL, WHITE);
	floodfill(2, 2, 8);
	settextstyle(0, 0, 1);
	outtextxy(10, 20, "Operation :");
